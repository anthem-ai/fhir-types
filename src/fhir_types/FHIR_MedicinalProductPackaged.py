...
FHIR_MedicinalProductPackaged = TypedDict(
    "FHIR_MedicinalProductPackaged",
    {
        # This is a MedicinalProductPackaged resource
        "resourceType": Literal["MedicinalProductPackaged"],
        ...
        "marketingAuthorization": FHIR_Reference,
        # Manufacturer of this Package Item.
        "manufacturer": List[FHIR_Reference],
        # Batch numbering.
        "batchIdentifier": List[FHIR_MedicinalProductPackaged_BatchIdentifier],
        # A packaging item, as a contained for medicine, possibly with other packaging items within.
        "packageItem": List[FHIR_MedicinalProductPackaged_PackageItem],
    },
    total=False,
)
