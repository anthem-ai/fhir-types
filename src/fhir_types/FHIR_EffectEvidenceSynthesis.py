...
FHIR_EffectEvidenceSynthesis = TypedDict(
    "FHIR_EffectEvidenceSynthesis",
    {
        # This is a EffectEvidenceSynthesis resource
        "resourceType": Literal["EffectEvidenceSynthesis"],
        ...
        "exposureAlternative": FHIR_Reference,
        # A reference to a EvidenceVariable resomece that defines the outcome for the research.
        "outcome": FHIR_Reference,
        # A description of the size of the sample involved in the synthesis.
        "sampleSize": FHIR_EffectEvidenceSynthesis_SampleSize,
        # A description of the results for each exposure considered in the effect estimate.
        "resultsByExposure": List[FHIR_EffectEvidenceSynthesis_ResultsByExposure],
        # The estimated effect of the exposure variant.
        "effectEstimate": List[FHIR_EffectEvidenceSynthesis_EffectEstimate],
        # A description of the certainty of the effect estimate.
        "certainty": List[FHIR_EffectEvidenceSynthesis_Certainty],
    },
    total=False,
)
