...
FHIR_MedicinalProductPharmaceutical = TypedDict(
    "FHIR_MedicinalProductPharmaceutical",
    {
        # This is a MedicinalProductPharmaceutical resource
        "resourceType": Literal["MedicinalProductPharmaceutical"],
        ...
        "administrableDoseForm": FHIR_CodeableConcept,
        # Todo.
        "unitOfPresentation": FHIR_CodeableConcept,
        # Ingredient.
        "ingredient": List[FHIR_Reference],
        # Accompanying device.
        "device": List[FHIR_Reference],
        # Characteristics e.g. a products onset of action.
        "characteristics": List[FHIR_MedicinalProductPharmaceutical_Characteristics],
        # The path by which the pharmaceutical product is taken into or makes contact with the body.
        "routeOfAdministration": List[
            FHIR_MedicinalProductPharmaceutical_RouteOfAdministration
        ],
    },
    total=False,
