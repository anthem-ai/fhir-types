...
FHIR_MeasureReport = TypedDict(
    "FHIR_MeasureReport",
    {
        ...
        "type": Literal["individual", "subject-list", "summary", "data-collection"],
        # Extensions for type
        "_type": FHIR_Element,
        # A reference to the Measure that was calculated to produce this report.
        "measure": FHIR_canonical,
