...
FHIR_CoverageEligibilityResponse_Item = TypedDict(
    "FHIR_CoverageEligibilityResponse_Item",
    {
        ...
        "benefit": List[FHIR_CoverageEligibilityResponse_Benefit],
        # A boolean flag indicating whether a preauthorization is required prior to actual service delivery.
        "authorizationRequired": FHIR_boolean,
        # Extensions for authorizationRequired
        "_authorizationRequired": FHIR_Element,
        # Codes or comments regarding information or actions associated with the preauthorization.
        "authorizationSupporting": List[FHIR_CodeableConcept],
        # A web location for obtaining requirements or descriptive information regarding the preauthorization.
        "authorizationUrl": FHIR_uri,
        # Extensions for authorizationUrl
        "_authorizationUrl": FHIR_Element,
    },
    total=False,
)
