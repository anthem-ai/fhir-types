...
FHIR_EvidenceVariable = TypedDict(
    "FHIR_EvidenceVariable",
    {
        # This is a EvidenceVariable resource
        "resourceType": Literal["EvidenceVariable"],
        ...
        "type": Literal["dichotomous", "continuous", "descriptive"],
        # Extensions for type
        "_type": FHIR_Element,
        # A characteristic that defines the members of the evidence element. Multiple characteristics are applied with "and" semantics.
        "characteristic": List[FHIR_EvidenceVariable_Characteristic],
    },
    total=False,
)
