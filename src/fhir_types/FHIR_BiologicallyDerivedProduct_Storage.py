...
FHIR_BiologicallyDerivedProduct_Storage = TypedDict(
    "FHIR_BiologicallyDerivedProduct_Storage",
    {
        ...
        # Storage temperature.
        "temperature": FHIR_decimal,
        # Extensions for temperature
        "_temperature": FHIR_Element,
        # Temperature scale used.
        "scale": Literal["farenheit", "celsius", "kelvin"],
        # Extensions for scale
        "_scale": FHIR_Element,
        # Storage timeperiod.
        "duration": FHIR_Period,
    },
    total=False,
)
