...
FHIR_SupplyRequest = TypedDict(
    "FHIR_SupplyRequest",
    {
        # This is a SupplyRequest resource
        "resourceType": Literal["SupplyRequest"],
        ...
        "parameter": List[FHIR_SupplyRequest_Parameter],
